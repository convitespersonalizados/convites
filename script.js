// Inicializa animações
    ...
    const portfolioImages = [
      ...
      { 
        src: 'https://via.placeholder.com/600x400?text=Convite+Corporativo', 
        title: 'Lançamento Corporativo | Tech Solutions',
        description: 'Design profissional com animação moderna e interativa'
      },
      { 
        src: 'https://via.placeholder.com/600x400?text=Convite+Casamento+2', 
        title: 'Casamento Campestre | Ana & Lucas',
        description: 'Tema rústico com animação de natureza e efeitos orgânicos'
      },
      { 
